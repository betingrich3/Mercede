...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x515443("> *Group Is now openned By Mercedes*");
    }, _0x57d309);
...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x5c514e("> *Group Now Closed By Mercedes*");
    }, _0x4b2fe4);
...
cmd({
  ...
  try {
    ...
    let _0x14ad67 = "*Summoning All Admins:*\n\n";
...
cmd({
  ...
  try {
    ...
    if (!_0xf475c2) {
      return _0x4beca6("Mercedes Must be an admin to use this command.");
    }
    if (!_0x533cde) {
...
cmd({
  ...
  try {
    ...
    if (!_0x12d593) {
      return _0x4c430b("Mercedes must be an admin to use this command.");
    }
    if (!_0x35af97) {
